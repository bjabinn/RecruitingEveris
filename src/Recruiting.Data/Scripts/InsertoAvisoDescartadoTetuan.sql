    ...
    <div>
        <div style="padding-left:1cm;padding-right:1cm">
            ...
            <div style="TEXT-ALIGN: justify;FONT-FAMILY: " Calibri","sans-serif";FONT-SIZE 11pt;">
                Nous tenons à vous remercier pour l’intérêt que vous avez porté à everis ainsi que pour le
                temps que vous nous avez consacré lors du processus de recrutement.
            </div>
            <br />

            <div style="TEXT-ALIGN: justify;FONT-FAMILY: " Calibri","sans-serif";FONT-SIZE 11pt;">
                Cependant, après avoir analysé votre candidature avec soins, nous sommes au regret de vous
                annoncer que votre candidature n’a pas été retenue. Nous gardons malgré tout votre CV dans
                notre base de données et nous vous contacterons si de nouvelles opportunités qui correspondent
                à votre profil se présentent de nouveau.
            </div>
            <br />

            <div style="TEXT-ALIGN: justify;FONT-FAMILY: " Calibri","sans-serif";FONT-SIZE 11pt;">
                Nous  vous remercions pour le temps que vous nous avez consacré et restons à votre
...
', 4, 2017-06-06, 1, 'CorreoDescartado', 1170)
...
VALUES (30, 'Asunto', 4, 2017-06-06, 1, 'Recruiting Everis. Communication du résultat du processus de sélection')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'imagenFirma', 4, 2017-06-06, 1, 'logo_everis.png')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LineaDireccion', 4, 2017-06-06, 1, 'TetouanShore Park-Shore 3
Route de Cabo Negro')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LineaEmail', 4, 2017-06-06, 1, 'Recruiting.Centers.Morocco@everis.com')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LineaProvincia', 4, 2017-06-06, 1, '93000 Martil, Morocco')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LineaTelefono', 4, 2017-06-06, 1, 'Tlf: +212 531 06 2990')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LineaTituloPie', 4, 2017-06-06, 1, 'Everis centers Morocco ')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LineaWeb', 4, 2017-06-06, 1, 'www.everis.com')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'LogoCabecera', 4, 2017-06-06, 1, 'CabeceraPlantillaCorreo.png')

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'NombreCandidato', 4, 2017-06-06, 1, NULL)

INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (30, 'Remitente', 4, 2017-06-06, 1, 'Recruiting.Centers.Morocco@everis.com')
