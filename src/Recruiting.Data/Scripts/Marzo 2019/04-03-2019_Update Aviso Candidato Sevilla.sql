...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
        ...
        <div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;">
            Por favor, no respondas a este e-mail directamente. Para contactar con nosotros puedes hacerlo en 
            <a href="mailto:Sev.DMF.Recruiting.Team@everis.com">Sev.DMF.Recruiting.Team@everis.com</a>
       </div>
       <br/>
