...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
		...
		<br/>
		<div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;>
			Su referenciado/a {0} ha recibido y aceptado correctamente la carta oferta para incorporarse a trabajar con nosotros.
		</div>~Candidato|
		<br/>
...
</html>', 4, 2018-11-13, 1, 'RefAceptaCO' , 98, null);
...
VALUES (101, 'Asunto', 4, 2018-11-13, 1, 'Notificacion Referenciado')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (101, 'imagenFirma', 4, 2018-11-13, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (101, 'LogoCabecera', 4, 2018-11-13, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (101, 'Remitente', 4, 2018-11-13, 1, 'Recruiting.Centers.Sevilla@everis.com')
