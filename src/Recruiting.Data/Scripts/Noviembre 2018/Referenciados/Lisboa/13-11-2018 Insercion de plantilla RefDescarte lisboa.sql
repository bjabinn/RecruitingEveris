...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
		...
		<br/>
		<div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;>
			O seu {0} referenciado não passou no nosso processo de seleção, temos outros candidatos que se encaixam mais de perto no perfil que estamos procurando hoje. Embora, estejamos com seu currículo para necessidades futuras.
		</div>~Candidato|
		<br/>
...
</html>', 4, 2018-11-13, 1, 'RefDescarte' , 1171, null);
...
VALUES (140, 'Asunto', 4, 2018-11-13, 1, 'Notificacion Referenciado')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (140, 'imagenFirma', 4, 2018-11-13, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (140, 'LogoCabecera', 4, 2018-11-13, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (140, 'Remitente', 4, 2018-11-13, 1, 'HPC.Lisboa.People@everis.com')
