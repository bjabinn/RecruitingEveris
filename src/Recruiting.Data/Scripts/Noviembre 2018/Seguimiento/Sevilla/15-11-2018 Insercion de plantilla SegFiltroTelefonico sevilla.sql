...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
		...
		<br/>
		<div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;>
			La persona {0} cuya candidatura está siguiendo ha sido incluida en nuestra base de datos, si existen necesidades acorde a su perfil profesional nos pondremos en contacto con él lo antes posible.
		</div>~Candidato|
		<br/>
...
</html>', 4, 2018-11-15, 1, 'SegFiltroTelefonico' , 98, null);
...
VALUES (145, 'Asunto', 4, 2017-08-29, 1, 'Notificacion Seguimiento')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (145, 'imagenFirma', 4, 2017-08-29, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (145, 'LogoCabecera', 4, 2017-86-29, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (145, 'Remitente', 4, 2017-08-29, 1, 'Recruiting.Centers.Sevilla@everis.com')
