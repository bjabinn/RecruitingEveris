...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
		...
		<br/>
		<div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;>
			A pessoa {0} cuja candidatura está seguindo não passou no nosso processo de seleção, temos outros candidatos que se encaixam mais de perto com o perfil que estamos procurando hoje. Embora, estejamos com seu currículo para necessidades futuras.
		</div>~Candidato|
		<br/>
...
</html>', 4, 2018-11-15, 1, 'SegDescarte' , 1171, null);
...
VALUES (190, 'Asunto', 4, 2017-08-29, 1, 'Notificacion Seguimiento')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (190, 'imagenFirma', 4, 2017-08-29, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (190, 'LogoCabecera', 4, 2017-86-29, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (190, 'Remitente', 4, 2017-08-29, 1, 'HPC.Lisboa.People@everis.com')
