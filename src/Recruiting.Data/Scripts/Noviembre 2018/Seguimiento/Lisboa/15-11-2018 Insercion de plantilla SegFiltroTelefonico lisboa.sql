...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
		...
		<br/>
		<div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;>
			A pessoa {0} cuja candidatura você está seguindo foi incluída em nosso banco de dados. Se houver necessidades de acordo com seu perfil profissional, entraremos em contato o mais breve possível.
		</div>~Candidato|
		<br/>
...
</html>', 4, 2018-11-15, 1, 'SegFiltroTelefonico' , 1171, null);
...
VALUES (185, 'Asunto', 4, 2017-08-29, 1, 'Notificacion Seguimiento')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (185, 'imagenFirma', 4, 2017-08-29, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (185, 'LogoCabecera', 4, 2017-86-29, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (185, 'Remitente', 4, 2017-08-29, 1, 'HPC.Lisboa.People@everis.com')
