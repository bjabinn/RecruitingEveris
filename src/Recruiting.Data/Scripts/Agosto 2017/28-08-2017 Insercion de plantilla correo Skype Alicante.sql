...
<div>
    <div style="padding-left:1cm;padding-right:1cm">
	    ...
	    <div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;">
			 Tal y como hemos quedado en nuestra conversación telefónica, te confirmo la entrevista con nosotros para el próximo <b>{0}</b> a las <b>{1}</b>.
        </div>~SoloFecha~SoloHora|
		<br/>
	 
	   <div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;">
			 Se pondrá en contacto contigo <b>{0}</b>
        </div>~NombreEntrevistador|
		<br/>
	   <div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;">
			 Por favor, confírmame la recepción de este correo y facilítanos tu dirección de Skype para poder contactarte.
        </div>
		<br/>		
	   <div style="TEXT-ALIGN: justify;FONT-FAMILY: "Calibri","sans-serif";FONT-SIZE: 11pt;">
...
</html>', 4, 2017-08-28, 1, 'AvisoEntrevistaCandidato' , 2, 4);
...
VALUES (34, 'Asunto', 4, 2017-08-29, 1, 'RRHH Everis. Aviso de entrevista programada')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (34, 'imagenFirma', 4, 2017-08-29, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (34, 'LogoCabecera', 4, 2017-86-29, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (34, 'Remitente', 4, 2017-08-29, 1, 'Spain.alc.hhrr@everis.com')
