...
</html>', 4, 2019-01-30, 1, 'DescarteBecaInterna' , 98, null);
...
VALUES (196, 'Asunto', 4, 2019-01-30, 1, 'Comunicación resultado proceso de selección')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (196, 'imagenFirma', 4, 2019-01-30, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (196, 'LogoCabecera', 4, 2019-01-30, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (196, 'Remitente', 4, 2019-01-30, 1, 'Recruiting.Centers.Sevilla@everis.com')
