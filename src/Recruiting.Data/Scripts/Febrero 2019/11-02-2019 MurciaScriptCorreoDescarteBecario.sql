...
</html>', 4, 2019-01-30, 1, 'DescarteBecaInterna' , 96, null);
...
VALUES (197, 'Asunto', 4, 2019-01-30, 1, 'Comunicación resultado proceso de selección')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (197, 'imagenFirma', 4, 2019-01-30, 1, 'logo_everis.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (197, 'LogoCabecera', 4, 2019-01-30, 1, 'CabeceraPlantillaCorreo.png')


INSERT INTO CorreoPlantillaVariable(PlantillaId, NombreVariable, UsuarioCreacionId, FechaCreacion, Activo, ValorDefecto) 
VALUES (197, 'Remitente', 4, 2019-01-30, 1, 'rrhh.murcia@everis.com')
