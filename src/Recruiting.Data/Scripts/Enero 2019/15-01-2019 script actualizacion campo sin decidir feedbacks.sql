...
SELECT E.EntrevistaId, E.SuperaEntrevista, E.TipoEntrevistaId, SinDecision, C.EstadoCandidaturaId
  FROM Entrevista E 
  JOIN CANDIDATURA C ON E.CandidaturaId = C.CandidaturaId

OPEN entrevista_cursor;
FETCH NEXT FROM entrevista_cursor INTO @EntrevistaID,@SuperaEntrevista,@TipoEntrevistaID,@SinDecision,@EstadoCandidatura;
